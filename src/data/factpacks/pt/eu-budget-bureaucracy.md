---
title: "A UE Gasta 60% do Orçamento em Burocracia?"
translationKey: "eu-budget-bureaucracy"
summary: "Uma alegação persistente diz que a maior parte do dinheiro da UE vai para burocratas em Bruxelas. A repartição real conta uma história muito diferente."
claim: "A União Europeia gasta 60% do seu orçamento em burocracia e administração"
verdict: "false"
...
### A Repartição Real do Orçamento

O Quadro Financeiro Plurianual da UE 2021-2027 distribui o orçamento da seguinte forma:

| Categoria | % do Orçamento | O que financia |
|-----------|----------------|----------------|
| Coesão e Desenvolvimento Regional | 35,2% | Infraestruturas, emprego, desenvolvimento em regiões mais pobres |
| Agricultura e Recursos Naturais | 31,0% | Subsídios agrícolas, desenvolvimento rural, segurança alimentar |
| Mercado Único e Inovação | 14,7% | Investigação (Horizon Europe), digital, espaço |
| Ação Externa | 9,2% | Ajuda externa, parcerias de segurança |
| **Administração** | **6,0%** | Todas as instituições da UE, pessoal, edifícios |
| Outros | 3,9% | Migração, segurança, outros |
